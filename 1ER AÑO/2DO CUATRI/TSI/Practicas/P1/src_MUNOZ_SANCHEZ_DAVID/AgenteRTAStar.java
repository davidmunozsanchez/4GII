...
public class AgenteRTAStar extends AbstractPlayer {
	...
	Vector2d fescala;
	Nodo portal;
	// boolean hayPlan; //Aqui se va paso a paso, estamos en tiempo real
...
//		}
	...
	public ACTIONS RTAStar(Nodo actual, Nodo objetivo, StateObservation state) {
		...
		hijo = sucesores.poll();
		ACTIONS accion = hijo.accion; //Se guarda la acción del primer mínimo
		int new_h = hijo.h + 1;
		...
		//Se aprende con el segundo mínimo, si no hay, con el primero
	...
	//Aquí se compara solo con la h y el contador, la g es constante para todas las posibles comparaciones
...
//				}
	...
	//Usado para comprobar si un movimiento nos va a llevar al objetivo
