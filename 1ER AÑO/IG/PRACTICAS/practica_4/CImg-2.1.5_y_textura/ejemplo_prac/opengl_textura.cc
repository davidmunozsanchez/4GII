...
// OBJETO A DIBUJAR
//ponemos tres puntos de la piramide, queremos asignarle una textura
...
//Los vertices segun la foto propia siguiendo distintos patrones
GLfloat texVertices[] = {0.0,0.5, 0.5,0.5, 0.5, 0.0,
...
void Init(int argc, char **argv){
   ...
   prepara_textura("./mistexturas.jpg", &textura_id);
}
